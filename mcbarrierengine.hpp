...
namespace QuantLib {
    ...
    */
    ...
    protected:
        ...
        ext::shared_ptr<path_generator_type> pathGenerator() const override {
            ...
            if (isConstantBS_) {
                ...
                return ext::shared_ptr<path_generator_type>(new path_generator_type(constBS, grid, gen, brownianBridge_));
    ...
    public:
        ...
        MakeMCBarrierEngine_2& withConstantParameters(bool isConstantBS);
    ...
    template <class RNG, class S>
    inline MakeMCBarrierEngine_2<RNG, S>&
        MakeMCBarrierEngine_2<RNG, S>::withConstantParameters(bool isConstantBS) {
